...
void          be_code_binop( bfuncinfo * finfo,
                             int         op,
                             bexpdesc *  e1,
                             bexpdesc *  e2 );
int           be_code_unop( bfuncinfo * finfo, int op, bexpdesc * e );
int           be_code_setvar( bfuncinfo * finfo,
                             bexpdesc *  e1,
                             bexpdesc *  e2 );
...
void          be_code_jumpbool( bfuncinfo * finfo,
                                bexpdesc *  e,
                                int         jumptrue );
