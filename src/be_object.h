...
#define var_setobj( _v, _t, _o ) __extension__ \
  ({                                           \
    ( _v )->v.p = _o;                          \
    var_settype( _v, _t );                     \
  })
...
#define var_setbool( _v, _b )     __extension__ \
  ({                                            \
    var_settype( _v, BE_BOOL );                 \
    ( _v )->v.b = (bbool) ( _b );               \
  })

#define var_setint( _v, _i )   __extension__ \
  ({                                         \
    var_settype( _v, BE_INT );               \
    ( _v )->v.i = ( _i );                    \
  })

#define var_setreal( _v, _r )   __extension__ \
  ({                                          \
    var_settype( _v, BE_REAL );               \
    ( _v )->v.r = ( _r );                     \
  })
...
#define var_setntvfunc( _v, _o )   __extension__ \
  ({                                             \
    ( _v )->v.nf = ( _o );                       \
    var_settype( _v, BE_NTVFUNC );               \
  })
